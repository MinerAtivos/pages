...
def generate_post_html(post, content, output_path):
    ...
    <article class="max-w-4xl mx-auto px-4 py-12">
        ...
        <footer class="mt-12 pt-8 border-t border-gray-200">
            ...
            <div style=" background-color: var(--primary-color); color: var(--heading-color); padding: 20px;
            text-align: center;
            border-radius: 8px;
            margin-top: 40px;
            font-size: 1.2em;
            font-weight: 700;">
                ...
                <p>Descubra como otimizar seu portfólio de forma inteligente.</p>
                <a href="https://minerativos.com.br?cadastro=true" target="_blank">Quero me cadastrar</a>
            </div>
        </footer>
    </article>
    """
