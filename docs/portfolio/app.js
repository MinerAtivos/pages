...
class B3App {
  ...
  renderMarketSummary() {
    ...
    this.$('summaryDateFull').textContent = `Dados atualizados em ${new Date(summary.date).toLocaleDateString('pt-BR')} (referente à coleta de ${new Date(summary.last_update).toLocaleDateString('pt-BR', {timeZone:'America/Sao_Paulo'})})`;
